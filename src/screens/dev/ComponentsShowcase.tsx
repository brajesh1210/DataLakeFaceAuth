  ...
  return (
    <GradientBackground>
      <AppHeader
        ...
        rightComponent={
          <Icon name="cog" size={24} color={colors.primary.navy} />
        }
      />
      <ScrollView
        ...
        <View style={styles.pageHeader}>
          ...
          <View
            ...
            <Text
              style={[
                typography.caption,
                {color: colors.text.white, fontWeight: 'bold'},
              ]}>
              19/19 Components Complete ✓
            </Text>
          </View>
        </View>
        ...
        <Card padding={0}>
          ...
          <ListItem
            icon={
              <Icon name="shield-check" size={24} color={colors.primary.navy} />
            }
            label="Safety Audit"
            onPress={() => {}}
